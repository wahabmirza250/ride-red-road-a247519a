...
export function BillingSignInScreen({ companySlug }: { companySlug?: string }) {
  ...
  return (
    <div className="surface-red relative flex min-h-screen items-center justify-center overflow-hidden bg-background px-4 py-10 text-foreground">
      <AuroraBackdrop />
      <div className="w-full max-w-md animate-rise-in">
        ...
        <div className="rounded-3xl border border-border/60 bg-surface/70 p-8 shadow-lift backdrop-blur-xl">
          <h1 className="text-xl font-semibold tracking-tight">Billing sign in</h1>
