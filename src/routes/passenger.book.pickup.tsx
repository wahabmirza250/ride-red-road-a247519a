...
function ConfirmPickup() {
  ...
  return (
    <div className="-mx-4 -mt-4 flex min-h-[calc(100dvh-3.5rem)] flex-col">
      {/* Map */}
      <div className="relative h-[38dvh] w-full shrink-0 overflow-hidden bg-surface-muted">
        {pickupCoords ? (
      ...
      {/* Bottom sheet — scrollable body + sticky CTA so "Confirm pickup" is always visible */}
      <div className="relative -mt-6 flex flex-1 flex-col rounded-t-3xl border-t border-border bg-background shadow-[0_-20px_60px_-20px_rgba(0,0,0,0.25)]">
        ...
        <div className="sticky bottom-0 shrink-0 border-t border-border bg-background/95 px-4 pb-[max(0.75rem,env(safe-area-inset-bottom))] pt-3 backdrop-blur">
          <Button
            onClick={next}
